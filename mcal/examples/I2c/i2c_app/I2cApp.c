...
static void I2c_appSequenceErrorReport(uint8 errorCode)
{
    ...
    {
        GT_0trace(I2C_APP_TRACE_MASK, GT_ERR, " Hardware unit busy!!\n\r");
    }
    else if (CDD_I2C_E_CHANNEL_BUSY == errorCode)
    {
        GT_0trace(I2C_APP_TRACE_MASK, GT_ERR, " Channels busy!!\n\r");
    }
    ...
    {
        GT_0trace(I2C_APP_TRACE_MASK, GT_ERR, " Receive shift register full!!\n\r");
    }
    else if (CDD_I2C_E_PARAM_QUEUE_FULL == errorCode)
    {
        GT_0trace(I2C_APP_TRACE_MASK, GT_ERR, " Queue full!!\n\r");
    }
    else
    {
