...
/* Read I2c sequence in polling mode */
        ...
        while (1)
        {
            ...
            if ((CDD_I2C_SEQ_OK == Cdd_I2cSequenceContainerLocal[CddI2cConf_CddI2cSequence_CddI2cSequence_3].SeqResult))
            {
                break;
            }
            if ((CDD_I2C_SEQ_FAILED == Cdd_I2cSequenceContainerLocal[3].SeqResult) ||
                (CDD_I2C_SEQ_CANCELLED == Cdd_I2cSequenceContainerLocal[3].SeqResult))
            {
        ...
        if (CDD_I2C_CH_RESULT_OK == Cdd_I2c_GetResult(CddI2cConf_CddI2cChannel_CddI2cChannel_3))
        {
