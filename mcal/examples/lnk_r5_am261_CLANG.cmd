...
PAGE 0:
    ...
    CPPI_DESC    (RW) : origin=0x70140000 length=0x00004000
...
SECTIONS
{
    ...
    .systcmsysvimRam : {} palign(8)    > TCMA_RAM
    ...
    .text               :     palign(8)               >  MCAL_CODE1, fill=FILL_PATTERN
    {
        .=align(8);
        __linker_text_start = .;
        . += FILL_LENGTH;
    ...
    .const      : palign(8) load > MCAL_CONST, fill=FILL_PATTERN
    {
        .=align(8);
    ...
    .rodata      : palign(8) load > MCAL_CONST, fill=FILL_PATTERN
    {
        .=align(8);
    ...
    .data       : palign(8) load > MCAL_DATA, fill=FILL_PATTERN
    {
        .=align(8);
        __linker_data_start = .;
        . += FILL_LENGTH;
    ...
    .bss        : palign(8) load > MCAL_BSS, fill=FILL_PATTERN
    ...
    McalTextSection : fill=FILL_PATTERN, palign(8) load > MCAL_CODE1
    {
        ...
        *(CAN_CALLOUT_TEXT_SECTION)
        ...
        .=align(8);
        __linker_cdd_cmpss_text_start = .;
        . += FILL_LENGTH;
        *(CDD_CMPSS_TEXT_SECTION)
        .=align(8);
        . += FILL_LENGTH;
        ...
        *(ADC_CALLOUT_TEXT_SECTION)
        ...
        . += FILL_LENGTH;
        *(CDD_FSIRX_TEXT_SECTION)
        *(CDD_FSIRX_ISR_TEXT_SECTION)
        *(CDD_FSIRX_CALLOUT_TEXT_SECTION)
        .=align(8);
        . += FILL_LENGTH;
        ...
        . += FILL_LENGTH;
        *(CDD_FSITX_TEXT_SECTION)
        *(CDD_FSITX_ISR_TEXT_SECTION)
        *(CDD_FSITX_CALLOUT_TEXT_SECTION)
        .=align(8);
        . += FILL_LENGTH;
    ...
    McalConstSection : fill=FILL_PATTERN, palign(8) load > MCAL_CONST
    {
        ...
        *(CAN_CONFIG_SECTION)
        ...
        .=align(8);
        __linker_cdd_cmpss_const_start = .;
        . += FILL_LENGTH;
        *(CDD_CMPSS_CONST_UNSPECIFIED_SECTION)
        .=align(8);
        . += FILL_LENGTH;
        ...
        *(ADC_CONFIG_SECTION)
        ...
        . += FILL_LENGTH;
        *(CDD_FSIRX_CONST_UNSPECIFIED_SECTION)
        *(CDD_FSIRX_CONST_32_SECTION)
        *(CDD_FSIRX_CONST_16_SECTION)
        *(CDD_FSIRX_CONST_8_SECTION)
        *(CDD_FSIRX_CONFIG_SECTION)
        .=align(8);
        . += FILL_LENGTH;
        ...
        . += FILL_LENGTH;
        *(CDD_FSITX_CONST_UNSPECIFIED_SECTION)
        *(CDD_FSITX_CONST_32_SECTION)
        *(CDD_FSITX_CONST_16_SECTION)
        *(CDD_FSITX_CONST_8_SECTION)
        *(CDD_FSITX_CONFIG_SECTION)
        .=align(8);
        . += FILL_LENGTH;
    ...
    McalInitSection : palign(8) load > MCAL_DATA
    {
        ...
        *(ADC_DATA_INIT_8_SECTION)
        ...
        . += FILL_LENGTH;
        *(CDD_FSIRX_DATA_INIT_UNSPECIFIED_SECTION)
        *(CDD_FSIRX_DATA_INIT_32_SECTION)
        *(CDD_FSIRX_DATA_INIT_16_SECTION)
        *(CDD_FSIRX_DATA_INIT_8_SECTION)
        .=align(8);
        . += FILL_LENGTH;
        ...
        . += FILL_LENGTH;
        *(CDD_FSITX_DATA_INIT_UNSPECIFIED_SECTION)
        *(CDD_FSITX_DATA_INIT_32_SECTION)
        *(CDD_FSITX_DATA_INIT_16_SECTION)
        *(CDD_FSITX_DATA_INIT_8_SECTION)
        .=align(8);
        . += FILL_LENGTH;
    ...
    McalNoInitSection : palign(8) load > MCAL_NOINIT, type = NOINIT
    {
        ...
        *(ADC_DATA_NO_INIT_8_SECTION)
        ...
        . += FILL_LENGTH;
        *(CDD_FSIRX_DATA_NO_INIT_UNSPECIFIED_SECTION)
        *(CDD_FSIRX_DATA_NO_INIT_32_SECTION)
        *(CDD_FSIRX_DATA_NO_INIT_16_SECTION)
        *(CDD_FSIRX_DATA_NO_INIT_8_SECTION)
        .=align(8);
        . += FILL_LENGTH;
        ...
        . += FILL_LENGTH;
        *(CDD_FSITX_DATA_NO_INIT_UNSPECIFIED_SECTION)
        *(CDD_FSITX_DATA_NO_INIT_32_SECTION)
        *(CDD_FSITX_DATA_NO_INIT_16_SECTION)
        *(CDD_FSITX_DATA_NO_INIT_8_SECTION)
        .=align(8);
        . += FILL_LENGTH;
