...
#define CDD_I2C_MAX_CH                  (4U)

/** \brief Maximum sequence across all hwunit */
#define CDD_I2C_MAX_SEQ                 (4U)
...
extern void I2c_Seq0_Fail(uint8 errorCode);
extern void I2c_Seq1_Fail(uint8 errorCode);
extern void I2c_Seq2_Fail(uint8 errorCode);
extern void I2c_Seq3_Fail(uint8 errorCode);
