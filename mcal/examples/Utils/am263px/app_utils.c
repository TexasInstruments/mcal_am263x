...
extern uint32 __linker_mcal_text_start, __linker_mcal_text_end, __linker_mcal_isr_text_start,
    __linker_mcal_isr_text_end, __linker_mcal_const_start, __linker_mcal_const_end, __linker_mcal_data_start,
    __linker_mcal_data_end, __linker_mcal_bss_start, __linker_mcal_bss_end;

static uint32 gAppUtilsSecHoleAddrList[] = {
    ((uint32)&__linker_text_start),          ((uint32)&__linker_text_end) - APP_UTILS_LINKER_FILL_LENGTH,
    ((uint32)&__linker_const_start),         ((uint32)&__linker_const_end) - APP_UTILS_LINKER_FILL_LENGTH,
    ((uint32)&__linker_data_start),          ((uint32)&__linker_data_end) - APP_UTILS_LINKER_FILL_LENGTH,
    ((uint32)&__linker_bss_start),           ((uint32)&__linker_bss_end) - APP_UTILS_LINKER_FILL_LENGTH,
    ((uint32)&__linker_mcal_text_start),     ((uint32)&__linker_mcal_text_end) - APP_UTILS_LINKER_FILL_LENGTH,
    ((uint32)&__linker_mcal_isr_text_start), ((uint32)&__linker_mcal_isr_text_end) - APP_UTILS_LINKER_FILL_LENGTH,
    ((uint32)&__linker_mcal_const_start),    ((uint32)&__linker_mcal_const_end) - APP_UTILS_LINKER_FILL_LENGTH,
    ((uint32)&__linker_mcal_data_start),     ((uint32)&__linker_mcal_data_end) - APP_UTILS_LINKER_FILL_LENGTH,
    ((uint32)&__linker_mcal_bss_start),      ((uint32)&__linker_mcal_bss_end) - APP_UTILS_LINKER_FILL_LENGTH,
};
...
uint32 AppUtils_getCurTimeInMsec(void)
{
    ...
    if (E_OK == status)
    {
        curTimeMsec = (uint32)(((float)timerCount * 1000.0) / APP_UTILS_CFG_COUNTER_FREQ);
    }
...
uint32 AppUtils_getElapsedTimeInMsec(uint32 startTime)
{
    ...
    startCount = (uint32)(((float)startTime * APP_UTILS_CFG_COUNTER_FREQ) / 1000.0);
    ...
    if (E_OK == status)
    {
        elapsedTimeMsec = (uint32)(((float)elapsedCount * 1000.0) / APP_UTILS_CFG_COUNTER_FREQ);
    }
