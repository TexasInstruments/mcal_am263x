...
#define APP_UTILS_COUNTER_ID ((CounterType)0x0U)
/** brief Counter frequency */
#define APP_UTILS_COUNTER_FREQ (32000U)

#define SYS_CLOCK_FREQ_XTAL 1200U

#define SYS_CLOCK_FREQ_SYS_VCLK 6000U
 ...
 */
#define pinMuxReg ((pinMuxBase_t *)0x20C0000U)
