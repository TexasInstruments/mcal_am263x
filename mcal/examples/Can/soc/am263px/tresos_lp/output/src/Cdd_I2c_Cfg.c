...
CONST(Cdd_I2c_Sequence_Config, CDD_I2C_CONFIG_DATA) Cdd_I2cSequenceContainer[CDD_I2C_MAXIMUM_SEQUENCE_NUMBER] =
{
    [0] =
    {
        ...
        .SequenceCompleteNotify   = I2c_Iomux_Read_Callback,
        .SequenceErrorNotify      = I2c_Iomux_Read_Callback_Fail,
    ...
    [1] =
    {
        ...
        .MaxChannels              = 1U,
        .SeqResult                = CDD_I2C_SEQ_OK,
        .SequenceCompleteNotify   = I2c_Iomux_Write_Callback_Ptr,
        .SequenceErrorNotify      = I2c_Iomux_Write_Callback_Ptr_Fail,
        .RestartMode              = CDD_I2C_RESTART_MODE_STOP,
        .ChannelList              =
        {
    /* The Number Of Channels generated below are equal to the variable "CddI2cNumberOfChannelsInSequence" */
    ...
    [2] =
    {
        ...
        .MaxChannels              = 1U,
        .SeqResult                = CDD_I2C_SEQ_OK,
        .SequenceCompleteNotify   = I2c_Iomux_Write_Callback,
        .SequenceErrorNotify      = I2c_Iomux_Write_Callback_Fail,
        .RestartMode              = CDD_I2C_RESTART_MODE_STOP,
        .ChannelList              =
        {
    /* The Number Of Channels generated below are equal to the variable "CddI2cNumberOfChannelsInSequence" */
