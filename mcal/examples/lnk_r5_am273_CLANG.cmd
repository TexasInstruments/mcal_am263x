...
PAGE 0:
    ...
    L2_RAM_BANK0 (RW) : origin=0x10260000 length=0x0008B000
...
SECTIONS
{
    ...
    McalTextSection : fill=FILL_PATTERN, align=4, load > MCAL_CODE1
    {
        ...
        *(UART_CALLOUT_TEXT_SECTION)
        ...
        . += FILL_LENGTH;
        *(DMA_TEXT_SECTION)
        *(DMA_ISR_TEXT_SECTION)
        *(DMA_CALLOUT_TEXT_SECTION)
        .=align(4);
        . += FILL_LENGTH;
    ...
    McalConstSection : fill=FILL_PATTERN, align=4, load > MCAL_CONST
    {
       ...
       .=align(4);
        ...
        . += FILL_LENGTH;
        *(DMA_CONST_UNSPECIFIED_SECTION)
        *(DMA_CONST_32_SECTION)
        *(DMA_CONST_16_SECTION)
        *(DMA_CONST_8_SECTION)
        *(DMA_CONFIG_SECTION)
        .=align(4);
        . += FILL_LENGTH;
    ...
    McalInitSection : align=4, load > MCAL_DATA
    {
        ...
        *(UART_DATA_INIT_8_SECTION)
        ...
        . += FILL_LENGTH;
        *(DMA_DATA_INIT_UNSPECIFIED_SECTION)
        *(DMA_DATA_INIT_32_SECTION)
        *(DMA_DATA_INIT_16_SECTION)
        *(DMA_DATA_INIT_8_SECTION)
        .=align(4);
        . += FILL_LENGTH;
    ...
    McalNoInitSection : align=4, load > MCAL_NOINIT, type = NOINIT
    {
        ...
        *(UART_DATA_NO_INIT_8_SECTION)
        ...
        . += FILL_LENGTH;
        *(DMA_DATA_NO_INIT_UNSPECIFIED_SECTION)
        *(DMA_DATA_NO_INIT_32_SECTION)
        *(DMA_DATA_NO_INIT_16_SECTION)
        *(DMA_DATA_NO_INIT_8_SECTION)
        .=align(4);
        . += FILL_LENGTH;
