 ...
 *  \file     Spi_Mibspi.h
 *
 *  \brief    This file implements the SPI driver low level layer, handling of channels and
...
#define SPI_DMA_BUFF_ID (SPI_DLC_MIBTXSIZE - 1U)
/**********************************************************************************************************************
...
#define DMACTRL_PCURRENT(val) ((uint32)(val) << 0U)  /* bit 0:6   */
...
/*LDRA_INSPECTED 340 S MR:19.7 <INSPECTED> "Register handling macros*/
#define SPI_DLC_HIGHBYTE_GET(val)                                  \
    ((uint8)(((uint32)(val) & (uint32)0xFF00U) >> 8U)) /* bit 8:15 \
                                                        */
