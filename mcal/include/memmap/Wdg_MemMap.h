...
/*LDRA_INSPECTED 61 X MR:5.1,MR:5.2 "False trigger LDRA tool issue " */
...
#pragma clang section data=".data.WDG_DATA_INIT_UNSPECIFIED_SECTION"
#else
...
#if (defined CLANG) || (defined DIAB)
#pragma clang section data=".data.WDG_DATA_INIT_32_SECTION"
#else
...
#if (defined CLANG) || (defined DIAB)
#pragma clang section data=".data.WDG_DATA_INIT_16_SECTION"
#else
...
#if (defined CLANG) || (defined DIAB)
#pragma clang section data=".data.WDG_DATA_INIT_8_SECTION"
#else
 ...
 *  Code and Data memory sections to certain RAM area" */
#if (defined CLANG) || (defined DIAB)
#pragma clang section text=".text.WDG_TEXT_SECTION"
#else
...
#if (defined CLANG) || (defined DIAB)
#pragma clang section text=".text.WDG_ISR_TEXT_SECTION"
#else
...
#if (defined CLANG) || (defined DIAB)
#pragma clang section text=".text.WDG_CALLOUT_TEXT_SECTION"
#else
