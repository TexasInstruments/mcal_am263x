 ...
 *
 *  \brief    This file contains memory map section definition for Cdd I2c
 *
 */
...
#elif defined(CDD_I2C_START_SEC_VAR_INIT_16)
...
#elif defined(CDD_I2C_START_SEC_VAR_NO_INIT_32)
#undef CDD_I2C_START_SEC_VAR_NO_INIT_32
#define START_SEC_COMMON_VAR_NO_INIT_32

#elif defined(CDD_I2C_START_SEC_VAR_NO_INIT_16)
#undef CDD_I2C_START_SEC_VAR_NO_INIT_16
#define START_SEC_COMMON_VAR_NO_INIT_16

#elif defined(CDD_I2C_START_SEC_VAR_NO_INIT_8)
#undef CDD_I2C_START_SEC_VAR_NO_INIT_8
#define START_SEC_COMMON_VAR_NO_INIT_8

#elif defined(CDD_I2C_START_SEC_CONST_UNSPECIFIED)
#undef CDD_I2C_START_SEC_CONST_UNSPECIFIED
...
#elif defined(CDD_I2C_START_SEC_CONST_16)
#undef CDD_I2C_START_SEC_CONST_16
#define START_SEC_COMMON_CONST_16
#elif defined(CDD_I2C_START_SEC_CONST_8)
#undef CDD_I2C_START_SEC_CONST_8
...
#elif defined(CDD_I2C_START_SEC_CALLOUT_CODE)
#undef CDD_I2C_START_SEC_CALLOUT_CODE
#define START_SEC_COMMON_CALLOUT_CODE

#endif

#if defined(CDD_I2C_STOP_SEC_VAR_INIT_UNSPECIFIED)
#undef CDD_I2C_STOP_SEC_VAR_INIT_UNSPECIFIED
#define STOP_SEC_COMMON_VAR_INIT_UNSPECIFIED

#elif defined(CDD_I2C_STOP_SEC_VAR_INIT_32)
#undef CDD_I2C_STOP_SEC_VAR_INIT_32
#define STOP_SEC_COMMON_VAR_INIT_32

#elif defined(CDD_I2C_STOP_SEC_VAR_INIT_16)
...
#elif defined(CDD_I2C_STOP_SEC_VAR_NO_INIT_32)
#undef CDD_I2C_STOP_SEC_VAR_NO_INIT_32
#define STOP_SEC_COMMON_VAR_NO_INIT_32

#elif defined(CDD_I2C_STOP_SEC_VAR_NO_INIT_16)
#undef CDD_I2C_STOP_SEC_VAR_NO_INIT_16
#define STOP_SEC_COMMON_VAR_NO_INIT_16

#elif defined(CDD_I2C_STOP_SEC_VAR_NO_INIT_8)
#undef CDD_I2C_STOP_SEC_VAR_NO_INIT_8
#define STOP_SEC_COMMON_VAR_NO_INIT_8

#elif defined(CDD_I2C_STOP_SEC_CONST_UNSPECIFIED)
#undef CDD_I2C_STOP_SEC_CONST_UNSPECIFIED
...
#elif defined(CDD_I2C_STOP_SEC_CONST_16)
#undef CDD_I2C_STOP_SEC_CONST_16
#define STOP_SEC_COMMON_CONST_16
#elif defined(CDD_I2C_STOP_SEC_CONST_8)
#undef CDD_I2C_STOP_SEC_CONST_8
...
#elif defined(CDD_I2C_STOP_SEC_CALLOUT_CODE)
#undef CDD_I2C_STOP_SEC_CALLOUT_CODE
...
#ifdef MEMMAP_ERROR
#error "CDD_I2C_Memmap.h pragma error"
#endif
