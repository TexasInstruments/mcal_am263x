...
#if (defined CLANG) || (defined DIAB)
#pragma clang section data=".data.ETHTRCV_DATA_NO_INIT_UNSPECIFIED_SECTION"
#else
...
#if (defined CLANG) || (defined DIAB)
#pragma clang section data=".data.ETHTRCV_DATA_NO_INIT_32_SECTION"
#else
...
#if (defined CLANG) || (defined DIAB)
#pragma clang section data=".data.ETHTRCV_DATA_NO_INIT_16_SECTION"
#else
...
#if (defined CLANG) || (defined DIAB)
#pragma clang section data=".data.ETHTRCV_DATA_NO_INIT_8_SECTION"
#else
...
#if (defined CLANG) || (defined DIAB)
#pragma clang section data=".data.ETHTRCV_CONST_UNSPECIFIED_SECTION"
#else
...
#if (defined CLANG) || (defined DIAB)
#pragma clang section data=".data.ETHTRCV_CONST_32_SECTION"
#else
...
#if (defined CLANG) || (defined DIAB)
#pragma clang section data=".data.ETHTRCV_CONST_16_SECTION"
#else
...
#if (defined CLANG) || (defined DIAB)
#pragma clang section data=".data.ETHTRCV_CONST_8_SECTION"
#else
