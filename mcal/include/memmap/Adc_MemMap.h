...
#if (defined CLANG) || (defined DIAB)
#pragma clang section data=".data:ADC_DATA_NO_INIT_UNSPECIFIED_SECTION"
#else
...
#if (defined CLANG) || (defined DIAB)
#pragma clang section data=".data:ADC_DATA_NO_INIT_32_SECTION"
#else
...
#if (defined CLANG) || (defined DIAB)
#pragma clang section data=".data:ADC_DATA_NO_INIT_16_SECTION"
#else
...
#if (defined CLANG) || (defined DIAB)
#pragma clang section data=".data:ADC_DATA_NO_INIT_8_SECTION"
#else
...
#if (defined CLANG) || (defined DIAB)
#pragma clang section data=".data:ADC_CONST_UNSPECIFIED_SECTION"
#else
...
#if (defined CLANG) || (defined DIAB)
#pragma clang section data=".data:ADC_CONST_32_SECTION"
#else
...
#if (defined CLANG) || (defined DIAB)
#pragma clang section data=".data:ADC_CONST_16_SECTION"
#else
...
#if (defined CLANG) || (defined DIAB)
#pragma clang section data=".data:ADC_CONST_8_SECTION"
#else
 ...
 *  Code and Data memory sections to certain RAM area" */
#if (defined CLANG) || (defined DIAB)
#pragma clang section data=".data:ADC_CONFIG_SECTION"
#else
