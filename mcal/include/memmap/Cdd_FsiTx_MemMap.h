...
#if (defined CLANG) || (defined DIAB)
#pragma clang section data=".data:CDD_FSITX_DATA_NO_INIT_UNSPECIFIED_SECTION"
#else
...
#if (defined CLANG) || (defined DIAB)
#pragma clang section data=".data:CDD_FSITX_DATA_NO_INIT_32_SECTION"
#else
...
#if (defined CLANG) || (defined DIAB)
#pragma clang section data=".data:CDD_FSITX_DATA_NO_INIT_16_SECTION"
#else
...
#if (defined CLANG) || (defined DIAB)
#pragma clang section data=".data:CDD_FSITX_DATA_NO_INIT_8_SECTION"
#else
...
#if (defined CLANG) || (defined DIAB)
#pragma clang section data=".data:CDD_FSITX_CONST_UNSPECIFIED_SECTION"
#else
...
#if (defined CLANG) || (defined DIAB)
#pragma clang section data=".data:CDD_FSITX_CONST_32_SECTION"
#else
...
#if (defined CLANG) || (defined DIAB)
#pragma clang section data=".data:CDD_FSITX_CONST_16_SECTION"
#else
...
#if (defined CLANG) || (defined DIAB)
#pragma clang section data=".data:CDD_FSITX_CONST_8_SECTION"
#else
...
#if (defined CLANG) || (defined DIAB)
#pragma clang section data=".data:CDD_FSITX_CONFIG_SECTION"
#else
