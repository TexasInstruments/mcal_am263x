...
#define MCU_PWM_XBAR_EVENTAGG_CHECKEVT0 (0x10000000U)
#define MCU_PWM_XBAR_EVENTAGG_CHECKEVT1 (0x20000000U)
#define MCU_PWM_XBAR_EVENTAGG_CHECKEVT2 (0x40000000U)
#define MCU_PWM_XBAR_EVENTAGG_CHECKEVT3 (0x80000000U)
/** @} */
...
#define MCU_PWM_XBAR_FSIRX0_RX_TRIG0 (0x00000100U)
#define MCU_PWM_XBAR_FSIRX0_RX_TRIG1 (0x00000200U)
#define MCU_PWM_XBAR_FSIRX0_RX_TRIG2 (0x00000400U)
#define MCU_PWM_XBAR_FSIRX0_RX_TRIG3 (0x00000800U)
#define MCU_PWM_XBAR_ECAP0_TRIPOUT   (0x00010000U)
#define MCU_PWM_XBAR_ECAP1_TRIPOUT   (0x00020000U)
#define MCU_PWM_XBAR_ECAP2_TRIPOUT   (0x00040000U)
#define MCU_PWM_XBAR_ECAP3_TRIPOUT   (0x00080000U)
#define MCU_PWM_XBAR_ECAP4_TRIPOUT   (0x00100000U)
#define MCU_PWM_XBAR_ECAP5_TRIPOUT   (0x00200000U)
#define MCU_PWM_XBAR_ECAP6_TRIPOUT   (0x00400000U)
#define MCU_PWM_XBAR_ECAP7_TRIPOUT   (0x00800000U)
/** @} */
 ...
 *  @{
 */
#define MCU_PWM_XBAR_SYNCOUTXBAR_OUT0 (0x00000001U)
#define MCU_PWM_XBAR_SYNCOUTXBAR_OUT1 (0x00000002U)
#define MCU_PWM_XBAR_ADCSOCA_SEL      (0x00010000U)
#define MCU_PWM_XBAR_ADCSOCB_SEL      (0x00020000U)
/** @} */
...
#define MCU_CSL_CONTROLSS_PWMXBAR_PWMXBAR0_G0_SEL_MASK (0x0003FFFFU)
#define MCU_CSL_CONTROLSS_PWMXBAR_PWMXBAR0_G1_SEL_MASK (0x00FFFFFFU)
#define MCU_CSL_CONTROLSS_PWMXBAR_PWMXBAR0_G2_SEL_MASK (0xF0000FFFU)
#define MCU_CSL_CONTROLSS_PWMXBAR_PWMXBAR0_G3_SEL_MASK (0xFFFFFFFFU)
#define MCU_CSL_CONTROLSS_PWMXBAR_PWMXBAR0_G4_SEL_MASK (0x000003FFU)
#define MCU_CSL_CONTROLSS_PWMXBAR_PWMXBAR0_G5_SEL_MASK (0x000003FFU)
#define MCU_CSL_CONTROLSS_PWMXBAR_PWMXBAR0_G6_SEL_MASK (0x000003FFU)
#define MCU_CSL_CONTROLSS_PWMXBAR_PWMXBAR0_G7_SEL_MASK (0x00FF0F03U)
#define MCU_CSL_CONTROLSS_PWMXBAR_PWMXBAR0_G8_SEL_MASK (0x00030003U)
