...
Std_ReturnType      Mcu_ClockSetSourceMCAN4(Mcu_ClkSourceIdType clk_srcId, uint32 clkDivId);
Std_ReturnType      Mcu_ClockSetSourceMCAN5(Mcu_ClkSourceIdType clk_srcId, uint32 clkDivId);
Std_ReturnType      Mcu_ClockSetSourceMCAN6(Mcu_ClkSourceIdType clk_srcId, uint32 clkDivId);
Std_ReturnType      Mcu_ClockSetSourceMCAN7(Mcu_ClkSourceIdType clk_srcId, uint32 clkDivId);
...
Std_ReturnType      Mcu_ClockSetSourceRTI4(Mcu_ClkSourceIdType clk_srcId, uint32 clkDivId);
Std_ReturnType      Mcu_ClockSetSourceRTI5(Mcu_ClkSourceIdType clk_srcId, uint32 clkDivId);
Std_ReturnType      Mcu_ClockSetSourceRTI6(Mcu_ClkSourceIdType clk_srcId, uint32 clkDivId);
Std_ReturnType      Mcu_ClockSetSourceRTI7(Mcu_ClkSourceIdType clk_srcId, uint32 clkDivId);
...
Std_ReturnType      Mcu_ClockSetSourceOSPI(Mcu_ClkSourceIdType clk_srcId, uint32 clkDivId);
...
Std_ReturnType      Mcu_ClockSetSourceMCSPI5(Mcu_ClkSourceIdType clk_srcId, uint32 clkDivId);
Std_ReturnType      Mcu_ClockSetSourceMCSPI6(Mcu_ClkSourceIdType clk_srcId, uint32 clkDivId);
Std_ReturnType      Mcu_ClockSetSourceMCSPI7(Mcu_ClkSourceIdType clk_srcId, uint32 clkDivId);
