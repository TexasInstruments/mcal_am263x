 ...
 */
 ...
 /**********************************************************************************************************************
    Project: Port_am263px_res
    Date   : 2023-12-21 12:45:38
...
extern void Port_IsrNotification0(uint8 PortBankNum, uint8 PortBankChNum, Port_EdgeTrig Edge);
...
static CONST( Port_PinConfigType, PORT_PBCFG) PortConfigSet_0_PinConfig[] =
{
    ...
    },
    {
         ...
         .Port_PinDioChannelId = 21,
         .Port_RegOffsetAddr = PINB8_LIN2_RXD,
         //.Port_PinSignalName = (const sint8 *)"GPIO21",
...
static CONST( Port_DioRegConfigType, PORT_PBCFG) PortConfigSet_0_DioConfig[] =
{
    [0] =
    {
         ...
         .Port_DioInterruptNotification = (Port_IsrNotificationType) Port_IsrNotification0,
#endif
    },
};
