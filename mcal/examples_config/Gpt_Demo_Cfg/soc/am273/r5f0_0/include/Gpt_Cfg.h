...
#define GPT_MAX_CHANNELS                                    (8U)


/** \brief GP timer channels available for AM273x */
#define GPT_RTI_CH_MIN              (0U)
#define GPT_RTI_CH_MAX              (11U)
#define GPT_RTI_MAX              	(12U)
...
#define SOC_RTI1_REG_BASE       (0x02F7A000U)
#define SOC_RTI2_REG_BASE       (0x02F7A100U)
#define SOC_RTI3_REG_BASE       (0x02F7A200U)
