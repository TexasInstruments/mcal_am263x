...
#define Eth_GetMaxAleEntry()            (32U)
/** \brief ALE control ports mask */
#define CPSW_ALE_PORT_MASK              (0x3U)
/** \brief Address offset CPSW SS registers */
#define CPSW_SS_INT_EN_OFFSET           (0x80U)
#define CPSW_SS_INT_STATUS_OFFSET       (0xB0U)
#define CPSW_SS_IMAX_OFFSET             (0xE0U)
