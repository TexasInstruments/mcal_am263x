...
#define R5FSS0_0_TO_R5FSS0_1_SW_QUEUE \
    (IpcNotify_SwQueue *)(MSS_MBOX_MEM + MSS_MBOX_MEM_SIZE - (MAILBOX_MAX_SW_QUEUE_SIZE * 12U))
#define R5FSS0_0_TO_R5FSS1_0_SW_QUEUE \
    (IpcNotify_SwQueue *)(MSS_MBOX_MEM + MSS_MBOX_MEM_SIZE - (MAILBOX_MAX_SW_QUEUE_SIZE * 11U))
#define R5FSS0_0_TO_R5FSS1_1_SW_QUEUE \
    (IpcNotify_SwQueue *)(MSS_MBOX_MEM + MSS_MBOX_MEM_SIZE - (MAILBOX_MAX_SW_QUEUE_SIZE * 10U))
#define R5FSS0_1_TO_R5FSS0_0_SW_QUEUE \
    (IpcNotify_SwQueue *)(MSS_MBOX_MEM + MSS_MBOX_MEM_SIZE - (MAILBOX_MAX_SW_QUEUE_SIZE * 9U))
#define R5FSS0_1_TO_R5FSS1_0_SW_QUEUE \
    (IpcNotify_SwQueue *)(MSS_MBOX_MEM + MSS_MBOX_MEM_SIZE - (MAILBOX_MAX_SW_QUEUE_SIZE * 8U))
#define R5FSS0_1_TO_R5FSS1_1_SW_QUEUE \
    (IpcNotify_SwQueue *)(MSS_MBOX_MEM + MSS_MBOX_MEM_SIZE - (MAILBOX_MAX_SW_QUEUE_SIZE * 7U))
#define R5FSS1_0_TO_R5FSS0_0_SW_QUEUE \
    (IpcNotify_SwQueue *)(MSS_MBOX_MEM + MSS_MBOX_MEM_SIZE - (MAILBOX_MAX_SW_QUEUE_SIZE * 6U))
#define R5FSS1_0_TO_R5FSS0_1_SW_QUEUE \
    (IpcNotify_SwQueue *)(MSS_MBOX_MEM + MSS_MBOX_MEM_SIZE - (MAILBOX_MAX_SW_QUEUE_SIZE * 5U))
#define R5FSS1_0_TO_R5FSS1_1_SW_QUEUE \
    (IpcNotify_SwQueue *)(MSS_MBOX_MEM + MSS_MBOX_MEM_SIZE - (MAILBOX_MAX_SW_QUEUE_SIZE * 4U))
#define R5FSS1_1_TO_R5FSS0_0_SW_QUEUE \
    (IpcNotify_SwQueue *)(MSS_MBOX_MEM + MSS_MBOX_MEM_SIZE - (MAILBOX_MAX_SW_QUEUE_SIZE * 3U))
#define R5FSS1_1_TO_R5FSS0_1_SW_QUEUE \
    (IpcNotify_SwQueue *)(MSS_MBOX_MEM + MSS_MBOX_MEM_SIZE - (MAILBOX_MAX_SW_QUEUE_SIZE * 2U))
#define R5FSS1_1_TO_R5FSS1_0_SW_QUEUE \
