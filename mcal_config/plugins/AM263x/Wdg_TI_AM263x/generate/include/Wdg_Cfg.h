 ...
 * Other Header Files
 ******************************************************************************/
[!IF "not(node:empty(as:modconf('Wdg')[1]/WdgDemEventParameterRefs/*))"!][!//
#include "Dem.h"
[!ENDIF!][!//
...
#define WDG_REGISTER_READBACK_API  [!IF "as:modconf('Wdg')[1]/WdgGeneral/WdgRegisterReadbackApi = 'true'"!](STD_ON)[!ELSE!](STD_OFF)[!ENDIF!]
...
#define WDG_SKIP_FORCE_RESET       [!IF "as:modconf('Wdg')[1]/WdgGeneral/WdgSkipForceReset = 'true'"!](STD_ON)[!ELSE!](STD_OFF)[!ENDIF!]
/** @} */

/** \brief Watchdog Initial Timeout */
#define WDG_INITIAL_TIMEOUT        ([!"num:i(as:modconf('Wdg')[1]/WdgGeneral/WdgInitialTimeout)"!] * 1000)

/** \brief Watchdog Maximum Timeout */
#define WDG_MAX_TIMEOUT            ([!"num:i(as:modconf('Wdg')[1]/WdgGeneral/WdgMaxTimeout)"!] * 1000)
...
#define WDG_RTI_FREQUENCY          ((uint32)[!"as:modconf('Wdg')[1]/WdgGeneral/WdgRtiFrequency"!])
 ...
 */
[!NOCODE!][!//
[!IF "node:exists(as:modconf('Wdg')[1]/WdgDemEventParameterRefs)"!][!//
[!IF "not(node:refexists(as:modconf('Wdg')[1]/WdgDemEventParameterRefs/WDG_E_MODE_FAILED)) and not(node:refexists(as:modconf('Wdg')[1]/WdgDemEventParameterRefs/WDG_E_DISABLE_REJECTED)) and not(node:refexists(as:modconf('Wdg')[1]/WdgDemEventParameterRefs/WDG_E_HARDWARE_ERROR)) "!]
...
[!IF "node:exists(as:modconf('Wdg')[1]/WdgDemEventParameterRefs/*)"!][!//
[!IF "node:exists(as:modconf('Wdg')[1]/WdgDemEventParameterRefs/WDG_E_MODE_FAILED)"!][!//
/** \brief  WDG failed */
#ifndef WDG_E_MODE_FAILED
#define WDG_E_MODE_FAILED           ([!IF "node:refexists(as:modconf('Wdg')[1]/WdgDemEventParameterRefs/WDG_E_MODE_FAILED)"!]DemConf_DemEventParameter_[!"node:name(node:ref(as:modconf('Wdg')[1]/WdgDemEventParameterRefs/WDG_E_MODE_FAILED))"!][!ELSE!][!ERROR "No Hardawre refernece is provided but DEM is enabled"!][!ENDIF!])
#endif
[!ENDIF!][!//

[!IF "node:exists(as:modconf('Wdg')[1]/WdgDemEventParameterRefs/WDG_E_DISABLE_REJECTED)"!][!//
/** \brief  WDG disable rejected */
#ifndef WDG_E_DISABLE_REJECTED
#define WDG_E_DISABLE_REJECTED     ([!IF "node:refexists(as:modconf('Wdg')[1]/WdgDemEventParameterRefs/WDG_E_DISABLE_REJECTED)"!]DemConf_DemEventParameter_[!"node:name(node:ref(as:modconf('Wdg')[1]/WdgDemEventParameterRefs/WDG_E_DISABLE_REJECTED))"!][!ELSE!][!ERROR "No Hardawre refernece is provided but DEM is enabled"!][!ENDIF!])
#endif
[!ENDIF!][!//

[!IF "node:exists(as:modconf('Wdg')[1]/WdgDemEventParameterRefs/WDG_E_HARDWARE_ERROR)"!][!//
#ifndef WDG_E_HARDWARE_ERROR
/** \brief Hardware failed */
#define WDG_E_HARDWARE_ERROR          ([!IF "node:refexists(as:modconf('Wdg')[1]/WdgDemEventParameterRefs/WDG_E_HARDWARE_ERROR)"!]DemConf_DemEventParameter_[!"node:name(node:ref(as:modconf('Wdg')[1]/WdgDemEventParameterRefs/WDG_E_HARDWARE_ERROR))"!][!ELSE!][!ERROR "No Hardawre refernece is provided but DEM is enabled"!][!ENDIF!])
#endif
[!ENDIF!][!//
[!ENDIF!][!//
/* @} */
