...
#define GPT_CFG_C_MAJOR_VERSION    ([!"substring-before($moduleSoftwareVer,'.')"!]U)
#define GPT_CFG_C_MINOR_VERSION    ([!"substring-before(substring-after($moduleSoftwareVer,'.'),'.')"!]U)
#define GPT_CFG_C_PATCH_VERSION    ([!"substring-after(substring-after($moduleSoftwareVer,'.'),'.')"!]U)
...
/* ---- Perform version checking  ----------------------------------------- */
    ...
    #error "Version numbers of Gpt_Cfg.c and Gpt.h are inconsistent!"
#endif
...
static CONST(Gpt_ChannelConfigType, GPT_CFG) [!"@name"!]_ChannelConfig[[!"$NumChannels"!]] =
{
[!VAR "Index" = "0"!][!//
[!LOOP "GptChannelConfiguration/*"!][!//
[!WS "4"!][[!"num:i($Index)"!]] =
